...
public class Slots : IMinigame
{
	...
	public void draw(SpriteBatch b)
	{
		...
		for (int k = 0; k < 8; k++)
		{
			...
			b.Draw(Game1.objectSpriteSheet, basePos + new Vector2(8f, 8 + (k + 2) * 68), Game1.getSourceRectForStandardTileSheet(Game1.objectSpriteSheet, getIconIndex(which), 16, 16), Color.White, 0f, Vector2.Zero, 4f, SpriteEffects.None, 0.99f);
			b.Draw(Game1.objectSpriteSheet, basePos + new Vector2(76f, 8 + (k + 2) * 68), Game1.getSourceRectForStandardTileSheet(Game1.objectSpriteSheet, getIconIndex(which), 16, 16), Color.White, 0f, Vector2.Zero, 4f, SpriteEffects.None, 0.99f);
			b.Draw(Game1.objectSpriteSheet, basePos + new Vector2(144f, 8 + (k + 2) * 68), Game1.getSourceRectForStandardTileSheet(Game1.objectSpriteSheet, getIconIndex(which), 16, 16), Color.White, 0f, Vector2.Zero, 4f, SpriteEffects.None, 0.99f);
			int payout = 0;
			switch (k)
			{
			case 0:
