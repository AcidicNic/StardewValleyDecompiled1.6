	...
	public override void MovePosition(GameTime time, xTile.Dimensions.Rectangle viewport, GameLocation currentLocation)
	{
		...
		else if (moveRight)
		{
			...
			else
			{
				...
				tmp4.Height /= 4;
				bool topCorner2 = currentLocation.isCollidingPosition(tmp4, viewport, isFarmer: false, DamageToFarmer, isGlider, this);
				tmp4.Y += tmp4.Height * 3;
				bool bottomCorner2 = currentLocation.isCollidingPosition(tmp4, viewport, isFarmer: false, DamageToFarmer, isGlider, this);
		...
		else if (moveLeft)
		{
			...
			else
			{
				...
				tmp2.Height /= 4;
				bool topCorner = currentLocation.isCollidingPosition(tmp2, viewport, isFarmer: false, DamageToFarmer, isGlider, this);
				tmp2.Y += tmp2.Height * 3;
				bool bottomCorner = currentLocation.isCollidingPosition(tmp2, viewport, isFarmer: false, DamageToFarmer, isGlider, this);
