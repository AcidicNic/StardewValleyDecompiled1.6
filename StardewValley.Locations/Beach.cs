	...
	public override void MakeMapModifications(bool force = false)
	{
		...
		if (Game1.IsWinter && Game1.dayOfMonth >= 12 && Game1.dayOfMonth <= 13)
		{
			...
			else
			{
				if (getCharacterFromName("winter_derby_contestent0") != null)
				{
					getCharacterFromName("winter_derby_contestent0").drawOffset = new Vector2(0f, 96f);
					getCharacterFromName("winter_derby_contestent0").shouldShadowBeOffset = true;
				}
				if (getCharacterFromName("winter_derby_contestent1") != null)
				{
					getCharacterFromName("winter_derby_contestent1").Sprite.CurrentFrame = 2;
					getCharacterFromName("winter_derby_contestent1").drawOffset = new Vector2(0f, 96f);
					getCharacterFromName("winter_derby_contestent1").shouldShadowBeOffset = true;
				}
				if (getCharacterFromName("winter_derby_contestent2") != null)
				{
					getCharacterFromName("winter_derby_contestent2").Sprite.CurrentFrame = 3;
					getCharacterFromName("winter_derby_contestent2").drawOffset = new Vector2(0f, 96f);
					getCharacterFromName("winter_derby_contestent2").shouldShadowBeOffset = true;
				}
				if (getCharacterFromName("winter_derby_contestent3") != null)
				{
					getCharacterFromName("winter_derby_contestent3").Sprite.CurrentFrame = 1;
					getCharacterFromName("winter_derby_contestent3").drawOffset = new Vector2(0f, 96f);
					getCharacterFromName("winter_derby_contestent3").shouldShadowBeOffset = true;
				}
				if (getCharacterFromName("winter_derby_contestent4") != null)
				{
					getCharacterFromName("winter_derby_contestent4").Sprite.CurrentFrame = 2;
					getCharacterFromName("winter_derby_contestent4").drawOffset = new Vector2(0f, 96f);
					getCharacterFromName("winter_derby_contestent4").shouldShadowBeOffset = true;
				}
				if (getCharacterFromName("winter_derby_contestent5") != null)
				{
					getCharacterFromName("winter_derby_contestent5").Sprite.CurrentFrame = 8;
					getCharacterFromName("winter_derby_contestent5").shouldShadowBeOffset = true;
				}
				if (getCharacterFromName("winter_derby_contestent6") != null)
				{
					getCharacterFromName("winter_derby_contestent6").Sprite.CurrentFrame = 9;
					getCharacterFromName("winter_derby_contestent6").shouldShadowBeOffset = true;
				}
				if (getCharacterFromName("winter_derby_contestent7") != null)
				{
					getCharacterFromName("winter_derby_contestent7").Sprite.CurrentFrame = 10;
					getCharacterFromName("winter_derby_contestent7").shouldShadowBeOffset = true;
				}
				if (getCharacterFromName("winter_derby_contestent8") != null)
				{
					getCharacterFromName("winter_derby_contestent8").Sprite.CurrentFrame = 11;
					getCharacterFromName("winter_derby_contestent8").shouldShadowBeOffset = true;
				}
				if (getCharacterFromName("winter_derby_contestent9") != null)
				{
					getCharacterFromName("winter_derby_contestent9").Sprite.CurrentFrame = 12;
					getCharacterFromName("winter_derby_contestent9").shouldShadowBeOffset = true;
				}
				if (getCharacterFromName("winter_derby_contestent10") != null)
				{
					getCharacterFromName("winter_derby_contestent10").Sprite.CurrentFrame = 6;
					getCharacterFromName("winter_derby_contestent10").drawOffset = new Vector2(0f, 96f);
					getCharacterFromName("winter_derby_contestent10").shouldShadowBeOffset = true;
				}
				if (getCharacterFromName("winter_derby_contestent11") != null)
				{
					getCharacterFromName("winter_derby_contestent11").Sprite.CurrentFrame = 7;
					getCharacterFromName("winter_derby_contestent11").drawOffset = new Vector2(0f, 96f);
					getCharacterFromName("winter_derby_contestent11").shouldShadowBeOffset = true;
				}
			}
