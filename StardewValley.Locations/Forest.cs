	...
	public override void MakeMapModifications(bool force = false)
	{
		...
		if (Game1.IsSummer && Game1.dayOfMonth >= 20 && Game1.dayOfMonth <= 21)
		{
			...
			else
			{
				if (getCharacterFromName("derby_contestent0") != null)
				{
					getCharacterFromName("derby_contestent0").drawOffset = new Vector2(0f, 96f);
					getCharacterFromName("derby_contestent0").shouldShadowBeOffset = true;
				}
				if (getCharacterFromName("derby_contestent1") != null)
				{
					getCharacterFromName("derby_contestent1").Sprite.CurrentFrame = 2;
					getCharacterFromName("derby_contestent1").drawOffset = new Vector2(0f, 96f);
					getCharacterFromName("derby_contestent1").shouldShadowBeOffset = true;
				}
				if (getCharacterFromName("derby_contestent2") != null)
				{
					getCharacterFromName("derby_contestent2").Sprite.CurrentFrame = 3;
					getCharacterFromName("derby_contestent2").drawOffset = new Vector2(0f, 96f);
					getCharacterFromName("derby_contestent2").shouldShadowBeOffset = true;
				}
				if (getCharacterFromName("derby_contestent3") != null)
				{
					getCharacterFromName("derby_contestent3").Sprite.CurrentFrame = 1;
					getCharacterFromName("derby_contestent3").drawOffset = new Vector2(0f, 96f);
					getCharacterFromName("derby_contestent3").shouldShadowBeOffset = true;
				}
				if (getCharacterFromName("derby_contestent4") != null)
				{
					getCharacterFromName("derby_contestent4").Sprite.CurrentFrame = 2;
					getCharacterFromName("derby_contestent4").drawOffset = new Vector2(0f, 96f);
					getCharacterFromName("derby_contestent4").shouldShadowBeOffset = true;
				}
				if (getCharacterFromName("derby_contestent5") != null)
				{
					getCharacterFromName("derby_contestent5").Sprite.CurrentFrame = 8;
					getCharacterFromName("derby_contestent5").shouldShadowBeOffset = true;
				}
				if (getCharacterFromName("derby_contestent6") != null)
				{
					getCharacterFromName("derby_contestent6").Sprite.CurrentFrame = 9;
					getCharacterFromName("derby_contestent6").shouldShadowBeOffset = true;
				}
				if (getCharacterFromName("derby_contestent7") != null)
				{
					getCharacterFromName("derby_contestent7").Sprite.CurrentFrame = 10;
					getCharacterFromName("derby_contestent7").shouldShadowBeOffset = true;
				}
				if (getCharacterFromName("derby_contestent8") != null)
				{
					getCharacterFromName("derby_contestent8").Sprite.CurrentFrame = 11;
					getCharacterFromName("derby_contestent8").shouldShadowBeOffset = true;
				}
				if (getCharacterFromName("derby_contestent9") != null)
				{
					getCharacterFromName("derby_contestent9").Sprite.CurrentFrame = 12;
					getCharacterFromName("derby_contestent9").shouldShadowBeOffset = true;
				}
			}
