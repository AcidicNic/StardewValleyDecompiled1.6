...
public class Background
{
	...
	public virtual void draw(SpriteBatch b)
	{
		...
		{
			v.X = position.X + (float)(l * chunkWidth % (chunksWide * chunkWidth)) * zoom;
			v.Y = position.Y + (float)(l * chunkWidth / (chunksWide * chunkWidth) * chunkHeight) * zoom;
			if (backgroundImage == null)
			{
			...
			r2.X = chunks[l] * chunkWidth % backgroundImage.Width;
			r2.Y = chunks[l] * chunkWidth / backgroundImage.Width * chunkHeight;
