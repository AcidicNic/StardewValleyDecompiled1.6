...
public class Multiplayer
{
	...
	public static string protocolVersion => Game1.version + "-" + Game1.versionBuildNumber + ((Game1.versionLabel != null) ? ("+" + new string(Game1.versionLabel.Where(char.IsLetterOrDigit).ToArray())) : "");
	...
	public virtual IEnumerable<GameLocation> activeLocations()
	{
		...
		{
			if (location == Game1.currentLocation || !isAlwaysActiveLocation(location))
			{
				continue;
			}
