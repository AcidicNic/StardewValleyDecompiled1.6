...
public class Chest : Object
{
	...
	{
		if (dropInItem != null && dropInItem.HasContextTag("swappable_chest") && HasContextTag("swappable_chest") && dropInItem.Name.Contains("Chest") && (dropInItem.Name.Contains("Big") || !base.ItemId.Contains("Big")))
		{
			GameLocation location = Location;
			if (location != null)
			{
