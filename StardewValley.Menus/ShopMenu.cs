	...
	public override void draw(SpriteBatch b)
	{
		...
		for (int k = 0; k < forSaleButtons.Count; k++)
		{
			...
			if (item.ShouldDrawIcon())
			{
				...
				if (SpriteText.getWidthOfString(formattedDisplayName) > width - (hasPrice ? (100 + SpriteText.getWidthOfString(itemPriceAndStock[forSale[currentItemIndex + k]].Price + " ")) : 100) && formattedDisplayName.Length > (hasPrice ? 27 : 37))
				{
