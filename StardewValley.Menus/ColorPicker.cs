...
public class ColorPicker
{
	...
	public void draw(SpriteBatch b)
	{
		for (int k = 0; k < 24; k++)
		{
			Color c3 = HsvToRgb((double)k / 24.0 * 360.0, 0.9, 0.9);
			b.Draw(Game1.staminaRect, new Rectangle(bounds.X + bounds.Width / 24 * k, bounds.Y + hueBar.bounds.Center.Y - 2, hueBar.bounds.Width / 24, 4), c3);
		}
